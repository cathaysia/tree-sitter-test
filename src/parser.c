...
static const TSFieldMapEntry ts_field_map_entries[] = {
    [0] = { field_language, 0, .inherited = true },
    [1] = { field_platform, 0, .inherited = true },
    [2] = { field_language, 2 },
    [3] = { field_platform, 2 },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
    ...
    REDUCE(sym_attributes, 1, 0, 0),
    [52] = { .entry = { .count = 2, .reusable = false } },
    REDUCE(aux_sym_header_repeat1, 2, 0, 0),
    SHIFT_REPEAT(44),
